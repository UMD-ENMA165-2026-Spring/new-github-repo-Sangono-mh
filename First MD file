# Making this repo
## Step 1 - What I Did
For this repo, I chose to have the **README** file as well as a license just for formality's sake. In a real project, it would be important for me to make sure the **README** is well-made as a landing page for anyone who needs to understand the repo.
